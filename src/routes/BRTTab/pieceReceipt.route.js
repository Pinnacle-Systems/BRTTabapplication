...
const router = Router();
import { getLotNo,get,getLotDetails,update ,getOne,getLoomAndWeaver} from "../../services/BRTTabService/pieceReceipt.service.js";
...
router.get('/:lotId/:pcno',getLoomAndWeaver);
