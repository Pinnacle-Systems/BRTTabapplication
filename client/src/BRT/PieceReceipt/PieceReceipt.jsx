...
const translations = {
  ...
  ta: {
    ...
    noData: "தரவு இல்லை",
    summary: "சுருக்கம்",
    enteredPcs: "உள்ளிட்ட பீஸ்கள்",
    balancePcs: "மீதமுள்ள பீஸ்கள்",
    ...
    alertAddPiece: "குறைந்தது ஒரு பீஸ் சேர்க்கவும்",
    alertEnterPieceAndMeter: "பீஸ் எண் மற்றும் மீட்டர் உள்ளிடவும்",
    alertPieceNotZero: "பீஸ் எண் 0 ஆக இருக்கக் கூடாது",
    ...
    alertPieceExists: "பீஸ் எண் ஏற்கனவே உள்ளது",
    alertPieceGreaterThanReceipt:
      "பீஸ் எண் ரசீது பீஸ்களை விட அதிகமாக இருக்கக் கூடாது",
    alertPieceAlreadyExists: "பீஸ் எண் ஏற்கனவே உள்ளது",
