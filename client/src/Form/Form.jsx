...
const Form = ({ onClose, primaryColor }) => {
  ...
  const pageNames = [
    { id: 1, label: "Lot Preparation" },
    { id: 2, label: "Loading" },
    { id: 3, label: "UnLoading" },
    { id: 4, label: "Approval" },
    {id: 5, label: "Revert"},
    {id: 6, label: "User"}
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (!username || !password || !Object.values(checkboxes).some(Boolean)) {
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <PersonIcon fontSize="small" sx={{ color: alpha('#000', 0.6) }} />
                    </InputAdornment>
                  ),
                }}
            ...
            <Grid item xs={12}>
              <CompactTextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <LockIcon fontSize="small" sx={{ color: alpha('#000', 0.6) }} />
                    </InputAdornment>
                  ),
                  endAdornment: (
